...
@pytest.mark.parametrize(
    ...
    [
        (P([-8, 9, 8]), P([0, -3, 8]), 11, P([2, 3, 4]), P([0.5, 2.25])),
        (P([7, -5, 9]), P([-5, -2, -7]), 13, P([0, -8, 0]), P([2])),
        (P([-1, 9, 9]), P([-2, -5, 9]), 17, P([-9, -7, 1]), P([23, 11])),
        (P([5, 6, -4]), P([5, 9, -5]), 7, P([-9, 6, 3]), P([18, -9])),
        (P([8, 3, -4]), P([9, -6, 4]), 11, P([7, -3, -4]), P([6, 8])),
        (P([-5, -7, 4]), P([-8, -3, 7]), 17, P([6, -9, 3]), P([-18, 40])),
    ],
)
...
@pytest.mark.parametrize(
    "p1,p2,cmod,pmod,expected",
    [
        (P([6, -2, 9]), P([1, -9, 8]), 11, P([5, 6, 4]), P([-9, 0.75])),
        (P([-2, 8, 7]), P([-7, 5, -5]), 7, P([1, 6, -4]), P([1, 10.5])),
        (P([-9, -6, 7]), P([-5, -2, 9]), 7, P([0, 6, 6]), P([3, 7])),
        (P([6, 1, -8]), P([9, -3, -5]), 7, P([7, 1, -1]), P([320, 120])),
        (P([5, -8, -6]), P([4, 9, 4]), 13, P([7, -1, -1]), P([98, 8])),
        (P([-4, -4, 9]), P([4, -2, 4]), 7, P([2, -1, -1]), P([9, 4])),
    ],
)
