...
- *nr* is the dataset with the total number of students studing that language per year
- *pc* is the dataset with the percentage of students studing that language per year
